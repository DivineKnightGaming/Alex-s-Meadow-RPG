...
class Player extends FlxSprite
{
	...
	public function new(X:Int, Y:Int)
	{
		...
		loadGraphic(Reg.playerSprites[Reg.playerToken], true, 32, 32);
		
		animation.add("walkdown", [0, 1, 2, 3], 4, true);
		animation.add("walkup", [4, 5, 6, 7], 4, true);
		animation.add("walkleft", [8, 9, 10, 11], 4, true);
		animation.add("walkright", [12, 13, 14, 15], 4, true);
	...
	{
		super.update();  
		if (Events.eventOpen == true || Events.battleOpen == true)
		{
