...
class TiledLevel extends TiledMap
{
	...
	private function loadObject(o:TiledObject, g:TiledObjectGroup, state:PlayState)
	{
		...
		switch (o.type.toLowerCase())
		{
			...
			case "good_node":
				Reg.goodnode = new Node(x, y, o.type, o.name, state, o.custom.shown, o.custom.open);
				state.add(Reg.goodnode);
				Reg.nodesGood.push(Reg.goodnode);
			case "bad_node":
				Reg.badnode = new Node(x, y, o.type, o.name, state, o.custom.shown, o.custom.open);
				state.add(Reg.badnode);
				Reg.nodesBad.push(Reg.badnode);
		}
	}
